...
export const intakeRules = {
  sections: {
    ...
    "SCHOOL INFORMATION": {
      ...
      required: ["Highest Grade Completed", "School name where highest grade completed", "Country where school located", "School City", "School State", "School End Date"],
      optional: ["School Address Line 1", "School Address Line 2", "School Zip Code", "School Phone Number", "Teacher Name"]
    },
    "CHILDREN INFORMATION": { required: ["Have any children", "Unmarried children 18-19 in high school", "No children under 18 and no children disabled prior to age 22"] }
  },
  ...
  records: {
    ...
    providers: {
      ...
      required: ["Clinic Name", "Phone Number", "Address", "City", "State", "Zipcode"],
      optional: ["Doctor First Name", "Doctor Last Name", "Address 2", "Notes", "First Visit Date", "Next Visit Date"]
    },
    ...
    spouse: {
      ...
      required: ["First Name", "Last Name", "Maiden Name", "Social Security Number", "Marriage Date", "Birth Country", "Birth City", "Birth State", "Age", "City of Marriage", "State of Marriage", "Type of Marriage"]
    },
    // No guessed child heading names: identify field-bearing records in CHILDREN INFORMATION.
    children: { section: "CHILDREN INFORMATION", required: ["First Name", "Last Name"], otherFieldsOptional: true }
  },
